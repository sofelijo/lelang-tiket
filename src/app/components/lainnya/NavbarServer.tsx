  ...
  <div className="max-w-screen-xl mx-auto px-4 py-3 flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
    ...
    <div className="flex items-center justify-between w-full">
      ...
      <div className="flex items-center gap-4 text-sm font-medium">
        {/* Listing Tiket */}
        <button
          onClick={() => startTransition(() => router.push("/tambah-tiket"))}
          disabled={isPending}
              ...
              <PopoverContent className="w-80 p-4 space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  {notif.length > 0 && (
                    <button
                      onClick={async () => {
                        await fetch("/api/notifikasi/mark-all", { method: "PATCH" });
                        refreshNotif();
                      }}
                ...
                >
                  <div className="w-12 h-12 rounded-md overflow-hidden bg-gray-200">
                    {item.image ? (
                      ...
                      <div className="text-xs text-center pt-3 text-gray-500">No Img</div>
                    )}
                  </div>
                  <div>
