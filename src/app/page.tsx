...
export default function Home() {
  ...
  return (
    <main className="pt-0 px-0">
                  ...
                  >
                    <Card className="group overflow-hidden rounded-xl border border-gray-700 bg-gray-800/80 backdrop-blur-sm shadow-xl hover:scale-[1.02] transition-transform duration-500">
                      <div className="w-full h-28 relative">
                        ...
                        >
                          <span>
                            ⏰ {countdowns[ticket.id] || "00:00:00:00"}
                          </span>
                          <span>🔥 {ticket.jumlahBid} bid</span>
                        </motion.div>

                        {/* Badge kategori & harga */}
                        <div className="absolute bottom-2 left-2 flex flex-col items-start gap-1 z-20 transition-all duration-500 group-hover:translate-y-3 group-hover:opacity-0">
                          ...
                          <div className="bg-emerald-500 text-white text-[10px] font-semibold px-2 py-1 rounded-full shadow">
                            <AnimatedPrice
                              amount={Math.floor(
                                ticket.harga_terkini /
                                  (ticket.jumlah * 1.03 || 1)
                              )}
                            />
                          </div>
                        </div>
      ...
      <footer className="bg-gray-900 shadow-inner shadow-black/20 mt-12">
        <div className="max-w-screen-xl mx-auto px-4 py-8 flex flex-col md:flex-row items-center justify-between gap-6 text-sm text-gray-300">
          {/* Kiri: Link navigasi */}
          ...
          <div className="flex items-center gap-2">
            <span>📸</span>
            <a
              href="https://instagram.com/yuknawar"
              target="_blank"
